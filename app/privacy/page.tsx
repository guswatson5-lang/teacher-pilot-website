...
export const metadata: Metadata = {
  title: "Privacy Policy — Teacher Pilot",
};
    ...
    >
      <div className="flex-1 flex items-center justify-center px-6 py-24">
        <div className="max-w-xl w-full">
          ...
          >
            We take the privacy and security of your data seriously. Our full
            Privacy Policy is currently being finalised and will be published
            here shortly. If you have any questions in the meantime, please
            contact us.
          </p>
